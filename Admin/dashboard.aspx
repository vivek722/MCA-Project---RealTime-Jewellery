     	...
     	<div class="col_3">
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>
                          <asp:Label ID="lblord" runat="server" Text=""></asp:Label></strong></h5>
                      <span>Orders</span>
                    </div>
                </div>
        	</div>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>
                          <asp:Label ID="lblprofit" runat="server" Text=""></asp:Label></strong></h5>
    ...
    <div class="content_bottom">
     <div class="col-md-8 span_3">
	   ...
	   <div class="col-md-4 span_4">
		   ...
		   <div class="col-md-6 col_1_of_2 span_1_of_2">
             <a class="tiles_info">
			    ...
			    <div class="tiles-body red">
                    <asp:Label ID="lbl_ord" runat="server" Text=""></asp:Label></div>
			 </a>
		   </div>
		   <div class="col-md-6 col_1_of_2 span_1_of_2">
		...
		<div class="copy">
            <p>Copyright &copy;2022 RealTime Jewellery Dashboard. All rights reserved<%--| Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a> --%></p>
	    </div>
		</div>
