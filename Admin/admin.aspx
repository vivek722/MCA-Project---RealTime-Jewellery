          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="control-label">First Name</label>
                ...
                <asp:RequiredFieldValidator ID="rfv_fname" runat="server" ErrorMessage="Enter First Name" ForeColor="Red" ControlToValidate="txtfnm"></asp:RequiredFieldValidator>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Password</label>
                ...
                <asp:RequiredFieldValidator ID="rfv_pwd" runat="server" ErrorMessage="at least one digit, one alphabetic character, no special characters, and 6-15 characters in length." ForeColor="Red" ValidationExpression="(?!^[0-9]*$)(?!^[a-zA-Z]*$)^([a-zA-Z0-9]{6,15})$" ControlToValidate="txtpwd"></asp:RequiredFieldValidator>
            </div>
            <div class="form-group">
              <label class="control-label">Confirm Password</label>
                ...
                <asp:CompareValidator ID="cv_cpwd" runat="server" ErrorMessage="Password Doesn't Match" ControlToValidate="txtpwd" ControlToCompare="txtcpwd" ValueToCompare="txtcpwd"></asp:CompareValidator>
            </div>
            <div class="form-group">
