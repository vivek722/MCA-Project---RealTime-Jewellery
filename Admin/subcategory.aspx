          ...
          <fieldset>
            ...
            <div class="form-group">
             <%-- <button type="submit" class="btn btn-primary">Submit</button>--%>
              ...
              <asp:RequiredFieldValidator ID="rfv_subcat" runat="server" ErrorMessage="Enter Sub Category Name" ForeColor="Red" ControlToValidate="txtsubcatname"></asp:RequiredFieldValidator>
            <br />
