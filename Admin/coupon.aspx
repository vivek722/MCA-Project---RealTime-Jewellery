          ...
          <fieldset>
            ...
            <div class="form-group">
             ...
             <%--<button type="reset" class="btn btn-default">Reset</button>--%>
              ...
              <asp:RequiredFieldValidator ID="rfv_ccode" runat="server" ErrorMessage="Enter Coupon Code" ForeColor="Red" ControlToValidate="txtc_code"></asp:RequiredFieldValidator>
              <asp:RequiredFieldValidator ID="rfv_dis" runat="server" ErrorMessage="Enter Discount" ForeColor="Red" ControlToValidate="txt_dis"></asp:RequiredFieldValidator>
              <asp:RequiredFieldValidator ID="rfv_maxdis" runat="server" ErrorMessage="Enter Max Discount" ForeColor="Red" ControlToValidate="txt_maxdis"></asp:RequiredFieldValidator>
            <br />
