            ...
            <div class="form-group">
             <%-- <button type="submit" class="btn btn-primary">Submit</button>--%>
              ...
              <%--<button type="reset" class="btn btn-default">Reset</button>--%>
                ...
                <br />
                <asp:RequiredFieldValidator ID="rfv_pro" runat="server" ErrorMessage="Enter Product Name" ControlToValidate="txtproname" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
                <br />
