			...
			<div class="sort-grid">
				<div class="sorting">
                    ...
                    <asp:SqlDataSource ID="sql_a_z" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:constr %>" 
                        SelectCommand="SELECT * FROM [product] ORDER BY [proname]">
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="sql_z_a" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:constr %>" 
                        SelectCommand="SELECT * FROM [product] ORDER BY [proname] DESC">
                        <SelectParameters>
                            <asp:QueryStringParameter Name="proname" QueryStringField="proname" 
                                Type="String" />
                        </SelectParameters>
                    ...
                    <asp:SqlDataSource ID="sql_h_l" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:constr %>" 
                        SelectCommand="SELECT * FROM [product] ORDER BY [proofferprice] DESC">
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="sql_l_h" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:constr %>" 
                        SelectCommand="SELECT * FROM [product] ORDER BY [proofferprice]">
                        <SelectParameters>
                            <asp:QueryStringParameter Name="proname" QueryStringField="proname" 
                                Type="String" />
                        </SelectParameters>
				...
				<div class="sorting">
                    ...
                    <asp:DropDownList ID="ddl_show" runat="server" AutoPostBack="True" 
                        ...
                        <asp:SqlDataSource ID="sql_5" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:constr %>" 
                            SelectCommand="SELECT TOP 5 * FROM [product]">
                        </asp:SqlDataSource>

                        <asp:SqlDataSource ID="sql_9" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:constr %>" 
                            SelectCommand="SELECT TOP 9 * FROM [product]">
                        </asp:SqlDataSource>
                        
                        <asp:SqlDataSource ID="sql_14" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:constr %>" 
                            SelectCommand="SELECT TOP 14 * FROM [product]">
                        </asp:SqlDataSource>
                    <div class="clearfix"></div>
				</div>
				<div class="clearfix"></div>
