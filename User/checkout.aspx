          ...
          <%--   <asp:ScriptManager ID="ScriptManager2" runat="server">
            ...
            <br />
             ...
             <div class="contact-form2">
				...
				<br />
                 <asp:RegularExpressionValidator ID="rev_uname" runat="server" ErrorMessage="Only character is valid for User Name.." ValidationExpression="^[a-zA-Z'.\s]{1,15}" ControlToValidate="txt_uname" SetFocusOnError="true" ForeColor="red"></asp:RegularExpressionValidator>
                <br />
                    <%--<input type="text" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="">--%>
                ...
                <asp:RegularExpressionValidator ID="rev_pin" runat="server" ValidationExpression="^([3]{1})([0-9]{5})$" ErrorMessage="Pincode Is Invalid" ForeColor="Red" SetFocusOnError="True" ControlToValidate="txt_pincode"></asp:RegularExpressionValidator>
                 <asp:RegularExpressionValidator ID="rev_loc" runat="server" ErrorMessage="Only character is valid for Locality.." ValidationExpression="^[a-zA-Z'.\s]{1,15}" ControlToValidate="txt_locality" SetFocusOnError="true" ForeColor="red" style="margin-left:430px;"></asp:RegularExpressionValidator>
                <br />
                 ...
                 <asp:RegularExpressionValidator ID="rev_add" runat="server" ErrorMessage="Only character is valid for Address.." ValidationExpression="^[a-zA-Z'.\s]{1,15}" ControlToValidate="txt_add" SetFocusOnError="true" ForeColor="red"></asp:RegularExpressionValidator><br />             
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;             
				...
				<br />
                 <asp:RegularExpressionValidator ID="rev_landmark" runat="server" ErrorMessage="Only character is valid for Landmark.." ValidationExpression="^[a-zA-Z'.\s]{1,15}" ControlToValidate="txt_landmark" SetFocusOnError="true" ForeColor="red"></asp:RegularExpressionValidator>
                <br />
           ...
           <asp:Panel ID="pnl_rd_pay" runat="server" Visible="False">
             <div class="contact-form2">
                 <asp:RadioButton ID="rd_btn_paytm" runat="server" GroupName="rd_btn_pay" 
                     oncheckedchanged="rd_btn_paytm_CheckedChanged" AutoPostBack="True"/>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lbl_paytm" runat="server" Text="Not Available"></asp:Label>
                <br />
                <br />
                 <asp:Panel ID="pnl_pay" runat="server" Visible="False">
                   ...
                   <%-- <asp:Button ID="btn_pay" runat="server" Text="Paytm" 
                 onclick="btn_pay_Click" Width="152px" BackColor="#FF9900" Height="42px" />--%>
