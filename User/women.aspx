    ...
    <div class="col-md-8 products-right" >
			...
			<div class="sort-grid">
				...
				<div class="sorting">
                    ...
                    <asp:DropDownList ID="ddl_show" runat="server" AutoPostBack="True" onselectedindexchanged="ddl_show_SelectedIndexChanged">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						...
						<li>
							<img class="img-responsive" src="discount/g_slider2.jpg" alt=" "/>
						</li>
					</ul>
				</div>
				<div class="clearfix"></div>
