		...
		<div class="new_grids">
			<div class="col-md-4 new-gd-left">
				...
				<div class="wed-brand simpleCart_shelfItem">
					<h5 style="color:Black;padding-left:30px;"><b>Flat 50% Discount on<br/> Making Charges</b></h5>
			...
			<div class="col-md-4 new-gd-middle">
				<div class="new-levis">
					<div class="mid-img">
						<img src="discount/bata.png" alt=" " />
					</div>
					<div class="mid-text">
						<h4>up to 25% <span>off</span></h4>
				...
				<div class="new-levis">
					...
					<div class="mid-img">
						<img src="discount/reebok-logo.jpg" alt=" " />
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="clearfix"></div>
			...
			<div class="col-md-4 new-gd-left">
				...
				<div class="wed-brandtwo simpleCart_shelfItem">
					<h4 style="color: White;font-weight:800">LATEST COLLECTIONS</h4>
					<p style="color: White;font-weight:500">Latest<br/>Offers</p>
				</div>
			</div>
			<div class="clearfix"></div>
		</div>
...
<div class="content-bottom">
	<div class="col-md-7 content-lgrid">
		...
		<div class="col-sm-6 content-img-right">
			<h3>Childrens Jewellery<span>Discount UPTO 20%</span></h3>
		</div>
		
		<div class="col-sm-6 content-img-right">
			<h3>Limited Offers<span>Real-Time</span>Special Offers</h3>
		</div>
		<div class="col-sm-6 content-img-left text-center">
			<div class="content-grid-effect slow-zoom vertical">
